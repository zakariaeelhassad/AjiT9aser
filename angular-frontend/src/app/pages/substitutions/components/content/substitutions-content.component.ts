...
import { SubstitutionsSidebarComponent } from '../sidebar/substitutions-sidebar.component';
import { SubstitutionsBoardComponent } from '../board/substitutions-board.component';
import { LineupSlot } from '../substitutions-types';

@Component({
  selector: 'app-substitutions-content',
  standalone: true,
  imports: [CommonModule, NavbarComponent, SubstitutionsSidebarComponent, SubstitutionsBoardComponent],
  templateUrl: './substitutions-content.component.html',
  styles: []
})
export class SubstitutionsContentComponent implements OnInit, OnDestroy {
  loadingLineup = true;
